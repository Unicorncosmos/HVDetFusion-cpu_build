...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default=r"C:\Users\GOKULNATH\Desktop\hvd\data\sets\nuscenes\backbone.pth", help='checkpoint file')
    parser.add_argument(
        ...
        for i, data in enumerate(data_loader):
            ...
            with torch.no_grad():
                ...
                for i in range(len(sess2_out)):
                    sess2_out[i] = torch.tensor(sess2_out[i])
